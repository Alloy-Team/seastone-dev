...
execute unless entity @s[dx=0] if entity @e[tag=sea.fruit.logia.flame.user,dx=0] run tag @s add sea.rayhit
execute unless entity @s[dx=0] unless entity @s[nbt={SelectedItem:{tag:{Sea:{Seastone:1b}}}}] unless entity @s[nbt={HandItems:[{tag:{Sea:{Seastone:1b}}}]}] if entity @e[tag=sea.fruit.logia.flame.user,dx=0] run tag @s add sea.facing.flame
execute unless entity @s[dx=0] if entity @e[tag=!sea.fruit.logia.flame.user,dx=0] run tag @s add sea.rayhit
execute unless entity @s[dx=0] if entity @s[nbt={SelectedItem:{tag:{Sea:{Seastone:1b}}}}] if entity @e[tag=sea.fruit.logia.flame.user,dx=0] 
