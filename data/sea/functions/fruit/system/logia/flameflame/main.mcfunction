...
# Nonhaki Immunity
execute as @e[distance=0.1..5] at @s unless predicate sea:player/seastone positioned ~ ~1 ~ positioned ^ ^ ^0.2 run function sea:fruit/system/logia/flameflame/faced
...
# Form
execute if entity @s[tag=!sea.fruit.logia.flame.lform,nbt=!{SelectedItem:{}},predicate=alloycore:player/sneak,tag=!ac_sneaked,x_rotation=90,tag=!sea.fruit.logia.flame.form] run function sea:fruit/system/logia/flameflame/form/enter
...
# Leg Form
execute if entity @s[tag=!sea.fruit.logia.flame.form,nbt=!{SelectedItem:{}},predicate=alloycore:player/sprint,predicate=alloycore:player/sneak,tag=!ac_sneaked,tag=!sea.fruit.logia.flame.lform] run function sea:fruit/system/logia/flameflame/lform/enter
execute if entity @s[tag=sea.fruit.logia.flame.lform] run function sea:fruit/system/logia/flameflame/lform/main
