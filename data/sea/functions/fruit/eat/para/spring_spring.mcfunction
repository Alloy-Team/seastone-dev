...
execute if score $sea.pf.spring sea.fruit.av matches 1 run tag @s[gamemode=!creative] remove sea.fruit.user
execute if score $sea.pf.spring sea.fruit.av matches 1 run tag @s[gamemode=!creative] remove sea.fruit.para.spring.user
scoreboard players set $sea.pf.spring sea.fruit.av 1
