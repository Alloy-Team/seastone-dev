...
execute if score $sea.pf.slip sea.fruit.av matches 1 run tag @s remove sea.fruit.user
execute if score $sea.pf.slip sea.fruit.av matches 1 run tag @s remove sea.fruit.para.slip.user
