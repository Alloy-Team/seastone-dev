...
execute if score $sea.lf.rumble sea.fruit.av matches 1 run tag @s[gamemode=!creative] remove sea.fruit.user
execute if score $sea.lf.rumble sea.fruit.av matches 1 run tag @s[gamemode=!creative] remove sea.fruit.logia.rumble.user
