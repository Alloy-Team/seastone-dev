...
execute if score $sea.lf.flame sea.fruit.av matches 1 run tag @s remove sea.fruit.user
execute if score $sea.lf.flame sea.fruit.av matches 1 run tag @s remove sea.fruit.logia.flame.user
